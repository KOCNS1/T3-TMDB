...
const Login = (props) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0 h-full">
      <div className="w-full bg-neutral text-white rounded-lg shadow md:mt-0 sm:max-w-xl xl:p-0">
          ...
          >
            <div>
              ...
              <input
                ...
                type="email"
                id="email"
                className="input input-bordered w-full max-w-s shadow-xl"
            ...
            <button
              type="submit"
              className="btn w-full text-black bg-accent-content"
            >
              Login
            </button>
            <p className="text-sm font-light text-accent-content">
